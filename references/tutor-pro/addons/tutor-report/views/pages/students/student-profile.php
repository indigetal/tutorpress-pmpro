	...
	<div class="tutor-mb-24">
		<div class="tutor-row tutor-align-lg-center">
			<div class="tutor-col-auto">
				<?php echo wp_kses( tutor_utils()->get_tutor_avatar( $user_info->ID, 'lg' ), tutor_utils()->allowed_avatar_tags() ); ?>
			</div>
				...
				<div class="tutor-card tutor-card-secondary tutor-p-24">
					<div class="tutor-d-flex">
						...
						<div class="tutor-ml-20">
							...
							<div class="tutor-fs-7 tutor-color-secondary"><?php esc_html_e( 'Completed Courses', 'tutor-pro' ); ?></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="tutor-card tutor-card-secondary tutor-p-24">
					<div class="tutor-d-flex">
						...
						<div class="tutor-ml-20">
							...
							<div class="tutor-fs-7 tutor-color-secondary"><?php esc_html_e( 'Reviews Placed', 'tutor-pro' ); ?></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="tutor-card tutor-card-secondary tutor-p-24">
					<div class="tutor-d-flex">
						...
						<div class="tutor-ml-20">
							...
							<div class="tutor-fs-7 tutor-color-secondary"><?php esc_html_e( 'Total Lessons', 'tutor-pro' ); ?></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="tutor-card tutor-card-secondary tutor-p-24">
					<div class="tutor-d-flex">
						...
						<div class="tutor-ml-20">
							...
							<div class="tutor-fs-7 tutor-color-secondary"><?php esc_html_e( 'Assignments', 'tutor-pro' ); ?></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="tutor-card tutor-card-secondary tutor-p-24">
					<div class="tutor-d-flex">
						...
						<div class="tutor-ml-20">
							...
							<div class="tutor-fs-7 tutor-color-secondary"><?php esc_html_e( 'Questions', 'tutor-pro' ); ?></div>
						</div>
					</div>
				</div>
			</div>
